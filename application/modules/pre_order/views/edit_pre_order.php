<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <form novalidate="novalidate" id="formEditPreOrder" action="<?= base_url('asisten-manager-gudang/edit-pre-order/mode-satuan')?>" method="post" accept-charset="utf-8">
                    <div class="card-header card-header-icon card-header-info">
                        <div class="card-icon">
                            <i class="material-icons">edit_drive_file</i>
                        </div>
                        <h4 class="card-title ">#<?= $data_pre_order->kode_pre_order?> - Mode Satuan <a href="<?= base_url('asisten-manager-gudang/view-edit-pre-order/'.$data_pre_order->kode_pre_order)?>" class="text-primary"><small>(ganti)</small></a></h4>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="edit_id_barang[<?= $i?>]" value="<?= $data_detail_pre_order[$i]->id_barang?>">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <select name="edit_satuan[<?= $i?>]" class="form-control">
...
<script>
    ...
    function tambah_rincian_barang(){
        ...
        md.setInputAutoCompleteAjax($cloned_element.find('[name="autocomplete_edit_id_barang['+$element_index+']"]'), '<?= base_url('asisten-manager-gudang/get-ajax-lookup-barang/per-ukuran')?>');
    }
    ...
    $(document).ready(function () {
        ...
        md.setInputAutoCompleteAjax('[name="autocomplete_edit_id_barang[0]"]', '<?= base_url('asisten-manager-gudang/get-ajax-lookup-barang/per-ukuran')?>');
        ...
        $.each($data_barang_pre_order, function (i, v) { 
            md.setInputAutoCompleteAjax('[name="autocomplete_edit_id_barang['+i+']"]',  '<?= base_url('asisten-manager-gudang/get-ajax-lookup-barang/per-ukuran')?>')
